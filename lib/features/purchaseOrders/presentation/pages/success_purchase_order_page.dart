...
class SuccessPurchaseOrderPage extends StatelessWidget {
  final String title;
  final String? image;
  const SuccessPurchaseOrderPage({super.key, required this.title, this.image});
  ...
  Widget build(BuildContext context) {
    return GradientScaffoldWidget(
      body: SuccessPageWidget(
        ...
        buttonWidth: 230,
        titleButton: 'Return to Purchase Order',
      ),
    );
  }
}
