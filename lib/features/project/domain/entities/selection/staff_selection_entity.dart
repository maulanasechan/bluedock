...
class StaffSelectionEntity {
  ...
  factory StaffSelectionEntity.fromJson(Map<String, dynamic> json) {
  ...
  factory StaffSelectionEntity.fromDoc(
    DocumentSnapshot<Map<String, dynamic>> doc,
  ) {
    final data = doc.data() ?? const <String, dynamic>{};
    return StaffSelectionEntity.fromJson({
