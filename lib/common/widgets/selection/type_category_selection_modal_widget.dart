...
class TypeCategorySelectionModalWidget extends StatelessWidget {
  final String subCollection;
  final String collection;
  final String document;
  final String selected;
  final PhosphorIconData icon;
  final void Function(TypeCategorySelectionEntity) onSelected;
  final List<BlocProvider> extraProviders;
  final bool? withoutIcon;
  final bool? withoutTitle;
  final TextAlign? align;

  const TypeCategorySelectionModalWidget({
    super.key,
                ...
                children: [
                  ...
                  >(
                    builder: (context, state) {
                      ...
                      if (state is TypeCategorySelectionDisplayFetched) {
